    ...
    if(isset($_GET["logout"])) {
        if($_GET["logout"] == "true") { ?>
            <div class="alert alert-success">
                ...
                You have been <strong>logged out</strong> of the system.
            </div>
    <?php
        }
    }
