                        ...
                        if(html == 'true') {
                            $("#add_err2").html(
                                '<div class="alert alert-success"> \
                                    <strong>User Authentication</strong> successful. \ \
                                </div>'
                                );
                            ...
                            $("#add_err2").html(
                                ...
                                <strong>User Authentication</strong> failure. \ \
                                </div>'
                                );
                        }
                        else {
    ...
    <div class="container">
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <div class="alert alert-danger">
                        You<strong> must </strong> be logged in to view the blog!
                    </div>
                    <hr>
                    ...
                    <div class="form-group col-lg-12"> Not a member? 
                        <a href="register.php"><button type="submit" class="btn btn-default">Register Here!</button></a>
                    </div>
                </div>
            </div>
        </div>
